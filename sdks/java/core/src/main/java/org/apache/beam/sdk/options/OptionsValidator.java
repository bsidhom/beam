...
public class OptionsValidator {
   ...
   * @param options The {@link Options} to validate.
   * @return Validated options.
   */
  public static <T extends Options> T validate(Class<T> klass, Options options) {
   ...
   * @return Validated options.
   */
  public static <T extends Options> T validateCli(Class<T> klass, Options options) {
  ...
  private static boolean verifyGroup(
      ProxyInvocationHandler handler, Options options, Collection<Method> requiredGroup) {
